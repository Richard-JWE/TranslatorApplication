...
root.resizable(0, 0)
root['bg'] = 'skyblue'
# translate_btn.config(bg='orange')
...
def Translate():
    ...
    translated = translator.translate(
        text=Input_text.get(), dest=dest_lang.get())
...
translate_btn = Button(
    ...
    pady=5,
    command=Translate,
    bg='blue',               # Background color when not clicked
    activebackground='green'  # Background color when clicked/activated
)
